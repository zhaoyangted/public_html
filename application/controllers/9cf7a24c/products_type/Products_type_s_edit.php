<?php
class Products_type_s_edit extends CI_Controller {
	...
	public function index($d_id,$TID='',$TTID=''){
        if(!empty($d_id)){
            ...
            // 撈取上層標題
            $Tdata=$this->mymodel->OneSearchSql('products_type','d_title',array('d_id'=>$dbdata['TID']));
	...
	public function edit(){
        ...
        $this->useful->AlertPage($this->AdminName.'/'.$dbname.'/'.$dbname.'_s/index/'.$dbdata['TID'],'修改成功');
    }
    // 刪除
