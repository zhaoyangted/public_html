<?php
class Products_type extends CI_Controller {
	...
	public function index(){
        ...
        $this->tableful->WhereSql=(!empty($this->tableful->WhereSql)?$this->tableful->WhereSql.'and TID =0':'where TID =0');
