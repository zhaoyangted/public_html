...
class Products_edit extends CI_Controller {
	...
	public function index($d_id){
        if(!empty($d_id)){
            ...
            $this->tableful->TableTreat(31,'and variant_id=1','d_model');
            $this->tableful->TableTreat(32,'and variant_id=3','d_model');
            $this->tableful->TableTreat(33,'and variant_id=2','d_model');
