<?php
class About_map extends CI_Controller
{
    ...
    public function index(){
        ...
        $dbdata = $this->mymodel->SelectPage($this->DBname, $this->tableful->SqlList . ',substr(d_date,1,16) as d_date', $this->tableful->WhereSql, 'd_date desc');
        $data['dbdata'] = $dbdata;
