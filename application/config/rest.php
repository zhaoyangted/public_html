...
|
*/
$config['allowed_cors_origins'] = ['http://localhost:3000','http://localhost','https://master.d3mlmyxf8zlcwd.amplifyapp.com','http://bgtwweb.s3-website-ap-northeast-1.amazonaws.com'];
