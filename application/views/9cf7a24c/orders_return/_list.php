  ...
  <div class="indexView_block">
    <div class="indexView_title">
      ...
      <?endif;?>
        <div class="indexView_block_search">
            <div class="search-btn">
              <a class="other" href="javascript:void(0)" id="DownOrder">匯出銷退單</a>
            </div>
        </div>
        <div class="toolbar">
          ...
          <tr>
            ...
            <?if($this->tableful->MenuidDb['d_edit']=='Y'):?>
              <td class="text-center">
                <a href="<? echo CCODE::DemoPrefix.'/'.((!empty($this->autoful->FileName)?$this->autoful->FileName:'admin_sys').'/'.$this->DBname.'_return/'.$this->DBname.'_return_edit/index/'.$dbval['d_id']);?>"><img class="ico-operating" src="<? echo CCODE::DemoPrefix.'/'.('images/backend/ico_p_edit.png')?>"></a>
              </td>
            <?endif;?>
            <?if($this->tableful->MenuidDb['d_del']=='Y'):?>
              <td class="text-center">
                <a href="javascript:void(0)" id="del_actions" rel="<?=$dbval['d_id']?>" dbrel="<? echo $this->DBname.'_return'?>"> <img class="ico-operating" src="<? echo CCODE::DemoPrefix.'/'.('images/backend/ico_p_trash.png')?>"></a>
              </td>
            <?endif;?>
          </tr>
          <?endforeach;endif;?>
...
$('#DownOrder').click(function(){
  $('#SearchForm').attr('action','orders_return/DownOrder').submit();
