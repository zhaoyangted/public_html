                ...
                ?>
                    ...
                    <?if($fvalue['d_type']==1):?>
                        ...
                        <li>
                            ...
                            <input type="text" class="form-control" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" value="<?php echo !empty($dbdata[$fvalue['d_fname']])?htmlentities($dbdata[$fvalue['d_fname']]):'';?>" <? if(!empty($fvalue['InputType'])):?>onkeyup="return <? echo $fvalue['InputType']?>($(this),value)"<? endif;?>>
                    ...
                    <?if($fvalue['d_type']==10):?>
                        ...
                        <li>
                            <div class="form_wrap_title"><?=$Star.$fvalue['d_title']?></div>
                            <input type="text" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" value="<?php echo !empty($dbdata[$fvalue['d_fname']])?($dbdata[$fvalue['d_fname']]!='0000-00-00')?date("Y-m-d", strtotime($dbdata[$fvalue['d_fname']])):'0000-00-00':'';?>" class="form-control">
                            <? if(!empty($fvalue['d_content'])):?>
                                <span class="form-remark"><? echo $fvalue['d_content'];?></span>
                            <?endif;?>
                        </li>
                    ...
                    <?if($fvalue['d_type']==17):?>
                        ...
                        <li>
                            <div class="form_wrap_title"><?=$Star.$fvalue['d_title']?></div><br>
                            <select name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" multiple <?echo $Disabled;?>>
                                <? foreach ($fvalue['Config'] as $Ckey=> $Cvalue):?>
                    ...
                    <?if($fvalue['d_type']==18):?>
                        ...
                        <li>
                            <div class="form_wrap_title"><?=$Star.$fvalue['d_title']?></div><br>
                            <input type="number" class="form-control" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" min="0" value="<? echo !empty($dbdata[$fvalue['d_fname']])?$dbdata[$fvalue['d_fname']]:7;?>" style="width: 100px;" <?echo $Disabled;?>>
                            <? if(!empty($fvalue['d_content'])):?>
                                <span class="form-remark"><? echo $fvalue['d_content'];?></span>
                            <?endif;?>
                        </li>
...
<? if(!empty($this->tableful->Menu)):foreach ($this->tableful->Menu as $fvalue):?>
    ...
    <?endif;?>
    <?if($fvalue['d_type']==17):?>
        $("#<?=$fvalue['d_fname']?>").select2({width:'1000px',maximumSelectionLength: 1});
    <?endif;?>
<?endforeach;endif;?>
</script>
