  ...
  <div class="indexView_block">
    <div class="indexView_title">
      ...
      <?endif;?>
        <div class="indexView_block_search">
            <div class="search-btn">
              <a class="other" href="javascript:void(0)" id="DownMember">會員匯出</a>
            </div>
        </div>
        <div class="toolbar">
          ...
          <tr>
            ...
            <?if($this->autoful->EditView==2):?>
              <td class="text-center">
                  <a href="javascript:void(0)" onclick="LoginMember(<?echo $dbval['d_id']?>);"><img class="ico-operating" src="<? echo CCODE::DemoPrefix.'/'.('images/backend/ico_p_edit.png')?>"></a>
              </td>
            <?endif;?>
...
$('#DownMember').click(function(){
  $('#SearchForm').attr('action','member/DownMember').submit();
