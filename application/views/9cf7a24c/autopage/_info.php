                ...
                ?>
                    ...
                    <?if($fvalue['d_type']==1):?>
                        ...
                        <li>
                            ...
                            <input type="text" class="form-control" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" value="<?php echo !empty($dbdata[$fvalue['d_fname']])?htmlentities($dbdata[$fvalue['d_fname']]):'';?>" <? if(!empty($fvalue['InputType'])):?>onkeyup="return <? echo $fvalue['InputType']?>($(this),value)"<? endif;?> <?echo $Disabled;?>>
                            ...
                            <div>
                                <?if($this->autoful->EditView==2):?>
                                    <div class="file_upload_btn">
                                        ...
                                        <input id="file-upload_<?echo $fvalue['d_fname'];?>" type="file" name="<?=$fvalue['d_fname']?>" <?echo $Disabled;?>/>
                                    </div>
                                <? endif;?>
                    ...
                    <?if($fvalue['d_type']==11):?>
                        ...
                        <li>
                            <div class="form_wrap_title"><?=$Star.$fvalue['d_title']?></div>
                            <input type="text" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" value="<?php echo !empty($dbdata[$fvalue['d_fname']])?$dbdata[$fvalue['d_fname']]:'';?>" class="form-control" <?echo $Disabled;?>>
                            <? if(!empty($fvalue['d_content'])):?>
                                <span class="form-remark"><? echo $fvalue['d_content'];?></span>
                            <?endif;?>
                        </li>
                    ...
                    <?if($fvalue['d_type']==13):?>
                        ...
                        <li>
                            ...
                            <input type="text" name="<?=$fvalue['d_fname']?>"  value="<?php echo !empty($dbdata[$fvalue['d_fname']])?$dbdata[$fvalue['d_fname']]:'';?>" class="form-control" <?echo $Disabled;?>>
                            <? if(!empty($fvalue['d_content'])):?>
                                <span class="form-remark"><? echo $fvalue['d_content'];?></span>
                            <?endif;?>
                        </li>
                        ...
                        <li>
                            ...
                            <div>
                                <div class="file_upload_btn">
                                    ...
                                    <input id="file-upload_<?echo $fvalue['d_fname'];?>" type="file" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" <?echo $Disabled;?>/>
                                </div>
                                <span id="UploadFile_<?=$fvalue['d_fname']?>"></span>
                                <? if(!empty($dbdata[$fvalue['d_fname']])):?>
                    ...
                    <?if($fvalue['d_type']==19):?>
                        ...
                        <li>
                            <div class="form_wrap_title"><?=$Star.$fvalue['d_title']?></div><br>
                            <input type="color" class="form-control" name="<?=$fvalue['d_fname']?>" id="<?=$fvalue['d_fname']?>" value="<? echo !empty($dbdata[$fvalue['d_fname']])?$dbdata[$fvalue['d_fname']]:'#ff0000';?>" style="width: 100px;height:50px;" <?echo $Disabled;?>>
                        </li>
                    <?endif;?>
                    <?if($fvalue['d_type']==20):?>
                        <!--DIV標籤-->
