  ...
  <div class="indexView_block">
    <div class="indexView_title">
      ...
      <div class="toolbar">
        ...
        <a href="<?echo site_url((!empty($this->autoful->FileName)?$this->autoful->FileName:'admin_sys').'/Autopage/Autopage/');?>" class="toolbar-btn disable">回首頁</a>
      </div>
    </div>
          ...
          <?if(!empty($dbdata)):foreach($dbdata as $value):?>
            <tr>
              ...
              <td class="text-center">
                <a href="<?echo site_url((!empty($this->autoful->FileName)?$this->autoful->FileName:'admin_sys').'/Autopage/Autopage/config_info/'.$value['d_id'].'');?>"><img class="ico-operating" src="<? echo base_url('images/backend/ico_p_edit.png')?>"></a>
              </td>
            </tr>
          <? endforeach;endif; ?>
        </tbody>
