    ...
    <article>
      ...
      <div class="box-1">
          ...
          <section class="right_box">
            <div class="title05 center">產品搜尋</div>
            <div class="g15 center">(關鍵字：<?echo $searchtext;?>)</div>
            <div class="sortbox">
              <div class="sort">
                <form method="post" id="Orderform">
                  ...
                  <input type="hidden" name="Pkeyword" value="<?echo $searchtext;?>" >
                  <input type="hidden" name="Ptype" value="<?echo (!empty($TID)?$TID:'');?>" >
                </form>
              </div>
            </div>
...
<script>
  ...
  $("#search_form").append('<input type="hidden" name="Ptype" value="<?echo (!empty($TID)?$TID:'');?>">');
