    ...
    <article>
      ...
      <div class="box-1">
        <ul class="breadcrumb">
          ...
          <li class="active"><?echo $BrandData['d_title']?></li>
        </ul>
      </div>
      <!--//bread-->
      <div class="box-1">
          <section class="left_box">
            <h2><?echo $BrandData['d_title']?></h2>
            <div class="pd-catalog"><?php include('_pd_catalog_brand.php');?></div>
          </section>
          <section class="right_box">
            ...
            <div class="title05 center"><?echo $BrandData['d_title']?></div>
            <div class="sortbox">
